...
onUpload:function(){},onUploadChunk:function(){},onResume:function(){},onProgress:function(){},onError:function(){},onAutoRetry:function(){},onManualRetry:function(){},onValidateBatch:function(){},onValidate:function(){},onSubmitDelete:function(){},onDelete:function(){},onDeleteComplete:function(){},onPasteReceived:function(){return(new qq.Promise).success()}},messages:{typeError:"{file} es de un tipo de archivo no admitido.<br>S&oacutelo puedes subir archivos del tipo: {extensions}.",sizeError:"{file} es muy grande,el tama&ntildeo m&aacuteximo es de {sizeLimit}.",
minSizeError:"{file} es muy peque&ntildeo, el tama&ntildeo m&iacutenimo es {minSizeLimit}.",emptyError:"{file} est&aacute vac&iacuteo, por favor seleccione otro archivo.",noFilesError:"No hay archivos para subir.",tooManyItemsError:"S&oacutelo se puede subir {itemLimit} archivo.",retryFailTooManyItems:"Reintento fallido - no se pueden subir m&aacutes archivos.",onLeave:"Se est&aacuten subiendo los archivos, no cierres la ventana."},retry:{enableAuto:!1,maxAutoAttempts:3,autoAttemptDelay:5,preventRetryResponseProperty:"preventRetry"},
...
qq.FineUploader=function(a){qq.FineUploaderBasic.apply(this,arguments);qq.extend(this._options,{element:null,listElement:null,dragAndDrop:{extraDropzones:[],hideDropzones:!0,disableDefaultDropzone:!1},text:{uploadButton:"Subir Archivo",cancelButton:"Cancelar",retryButton:"Reintentar",deleteButton:"Borrar",failUpload:"Fallo al subir archivo",dragZone:"Suelta el archivo aqu&iacute",dropProcessing:"Procesando...",formatProgress:"{percent}% de {total_size}",waitingForResponse:"Procesando..."},template:'<div class="qq-uploader">'+
