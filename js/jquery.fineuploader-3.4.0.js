...
qq.FineUploaderBasic = function(o){
    ...
    this._options = {
        ...
        messages: {
            typeError: "{file} es de un tipo de archivo no admitido.<br>S&oacutelo puedes subir archivos del tipo: {extensions}.",
            sizeError: "{file} es muy grande,el tama&ntildeo m&aacuteximo es de {sizeLimit}.",
            minSizeError: "{file} es muy peque&ntildeo, el tama&ntildeo m&iacutenimo es {minSizeLimit}.",
            emptyError: "{file} est&aacute vac&iacuteo, por favor seleccione otro archivo.",
            noFilesError: "No hay archivos para subir.",
            tooManyItemsError: "S&oacutelo se puede subir {itemLimit} archivo.",
            retryFailTooManyItems: "Reintento fallido - no se pueden subir m&aacutes archivos.",
            onLeave: "Se est&aacuten subiendo los archivos, no cierres la ventana."
        },
        retry: {
            enableAuto: false,
            maxAutoAttempts: 3,
...
qq.FineUploader = function(o){
    ...
    qq.extend(this._options, {
        ...
        text: {
            uploadButton: 'Sube unarchivo',
            cancelButton: 'Cancelar',
            retryButton: 'Reintentar',
            deleteButton: 'Borrar',
            failUpload: 'Fallo al subir archivo',
            dragZone: 'Suelta el archivo aquí',
        ...
        template: '<div class="qq-uploader">' +
            ...
            (!this._options.button ? '<div class="qq-upload-button" id="qq-upload-button"><div>{uploadButtonText}</div></div>' : '') +
